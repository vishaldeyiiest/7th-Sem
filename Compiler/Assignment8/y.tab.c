...
{
       0,    76,    76,    79,    79,   110,   120,   140,   141,   144,
     144,   151,   151,   154,   154,   161,   170,   174,   175,   176,
     177,   178,   179,   184,   226,   263,   311,   328,   337,   339,
     340,   341,   342,   343,   345,   346,   347,   348,   349,   350,
     352,   353,   354,   355,   356,   357,   359,   361,   362,   363,
     364,   365,   366,   367,   368,   370,   374,   375,   376,   377,
     378
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 76 "target.y" /* yacc.c:1646  */
    {out = formatCode((yyvsp[0].st).code); }
#line 1434 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 110 "target.y" /* yacc.c:1646  */
    {	int t = lookup_scope((yyvsp[0].tokname), scope); 
			...
			buffer_quad = (char *)realloc(buffer_quad, (strlen(buffer_quad) + strlen((yyvsp[0].tokname)) + 8) * sizeof(char));
			char temp[7]; sprintf(temp, "\n0x%x: ", memory);
			strcat(buffer_quad, temp);
			strcat(buffer_quad, (yyvsp[0].tokname)); //printf("%s\n", buffer_quad);
			
			add_address((yyvsp[0].tokname), 8, memory); memory++;
		}
#line 1449 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 121 "target.y" /* yacc.c:1646  */
    { 	int t = lookup_scope((yyvsp[-2].tokname), scope); 
				if(t != -1) printf("ERROR: '%s' redeclared at %d\n", (yyvsp[-2].tokname), yylineno);
				else	put_tobuffer((yyvsp[-2].tokname), (yyvsp[0].expr_st).type);
				add_address((yyvsp[-2].tokname), 8, memory);
				int temp_mem = memory;  memory++;
				char *temp_code = targetcode_assign((yyvsp[-2].tokname), (yyvsp[0].expr_st).place);
				buffer_quad = (char*)realloc(buffer_quad, (strlen(buffer_quad) + strlen((yyvsp[0].expr_st).code) + 
								strlen(temp_code) + strlen((yyvsp[-2].tokname)) + 12) * sizeof(char));
...
#line 1472 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 144 "target.y" /* yacc.c:1646  */
    {	buffer_quad = (char*)malloc(sizeof(char)); buffer_quad[0] = '\0'; }
#line 1478 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 145 "target.y" /* yacc.c:1646  */
    {	insert((yyvsp[-2].val.type)); 
				(yyval.st).code = (char*)malloc((strlen(buffer_quad)+1)*sizeof(char)); 
				strcpy((yyval.st).code, buffer_quad); free(buffer_quad);
			}
#line 1487 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 151 "target.y" /* yacc.c:1646  */
...
#line 1499 "y.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 154 "target.y" /* yacc.c:1646  */
    {scope++; printf("Entering Scope: %d\n", scope); }
#line 1505 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 155 "target.y" /* yacc.c:1646  */
    { //show_symtable(); 
		printf("Exiting Scope: %d\n", scope); exitscope(scope); scope--; 
		(yyval.st) = (yyvsp[-1].st); //show_symtable();
	}
#line 1514 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 161 "target.y" /* yacc.c:1646  */
    {	
				(yyval.st).code = (char *)malloc((strlen((yyvsp[-1].st).code) + strlen((yyvsp[0].st).code) + 2) * sizeof(char));
				strcpy((yyval.st).code, (yyvsp[-1].st).code);
				strcat((yyval.st).code, "\n");
				strcat((yyval.st).code, (yyvsp[0].st).code);
				(yyval.st).size = (yyvsp[-1].st).size + (yyvsp[0].st).size;
				free((yyvsp[-1].st).code);
				free((yyvsp[0].st).code);
			}
#line 1528 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 170 "target.y" /* yacc.c:1646  */
    {(yyval.st).code = (char *)malloc(sizeof(char)); (yyval.st).code[0] = '\0';}
#line 1534 "y.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 175 "target.y" /* yacc.c:1646  */
    { (yyval.st).code = (char *)malloc(sizeof(char)); (yyval.st).code[0] = '\0'; }
#line 1540 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 179 "target.y" /* yacc.c:1646  */
    { (yyval.st).code = (yyvsp[-1].expr_st).code; (yyval.st).size = (yyvsp[-1].expr_st).size; }
#line 1546 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 185 "target.y" /* yacc.c:1646  */
    {
		(yyval.st).code = (char *)malloc((strlen((yyvsp[-2].expr_st).code) + strlen((yyvsp[0].st).code) + 50) * sizeof(char));
		char *l1 = newLabel(), *l2 = newLabel(), *l3 = newLabel();
	
		memory = memory - (yyvsp[0].st).size-1;
		char loc[10]; //sprintf(loc, "\n0x%x: ", memory);
		strcpy((yyval.st).code, "\n");
		strcat((yyval.st).code, l1); strcat((yyval.st).code, ": ");
		strcat((yyval.st).code, (yyvsp[-2].expr_st).code);
	
		int jc_loc = memory+6;
		strcat((yyval.st).code, "\nJC "); 
		//sprintf(loc, "0x%x", jc_loc);
		strcat((yyval.st).code, l2);

		strcat((yyval.st).code, "\nJMP ");
		int jmp_loc = jc_loc+(yyvsp[0].st).size+1;
		//sprintf(loc, "0x%x", jmp_loc); 			
		strcat((yyval.st).code, l3);

		//sprintf(loc, "\n0x%x: ", jc_loc);
		strcat((yyval.st).code, "\n");
		strcat((yyval.st).code, l2); strcat((yyval.st).code, ": ");
		strcat((yyval.st).code, (yyvsp[0].st).code);

		strcat((yyval.st).code, "\nJMP ");
		//sprintf(loc, "0x%x", memory); 			
		strcat((yyval.st).code, l1);

		//sprintf(loc, "\n0x%x: ", jmp_loc);
		strcat((yyval.st).code, "\n");
		strcat((yyval.st).code, l3); strcat((yyval.st).code, ": ");
		(yyval.st).size = jmp_loc - memory;
		memory = jmp_loc;
...
#line 227 "target.y" /* yacc.c:1646  */
    {	
			...
			memory = memory - (yyvsp[0].st).size-1;
			strcpy((yyval.st).code, (yyvsp[-2].expr_st).code);
			char loc[10]; //sprintf(loc, "\n0x%x: ", memory);
			strcat((yyval.st).code, "\n");
			//strcat($$.code, loc); 
		
			int jc_loc = memory+6;
			strcat((yyval.st).code, "JC "); 
			//sprintf(loc, "0x%x", jc_loc);
			strcat((yyval.st).code, l1);
...
#line 1629 "y.tab.c" /* yacc.c:1646  */
  ...
  case 25:
#line 264 "target.y" /* yacc.c:1646  */
    {
		char *l1 = newLabel(), *l2 = newLabel(), *l3 = newLabel();
		(yyval.st).code = (char *)malloc((strlen((yyvsp[-4].expr_st).code) + strlen((yyvsp[-2].st).code) + strlen((yyvsp[0].st).code) + 70) * sizeof(char));
		strcpy((yyval.st).code, (yyvsp[-4].expr_st).code);
		memory = memory - (yyvsp[-2].st).size-1;
		char loc[10]; //sprintf(loc, "\n0x%x: ", memory);
		strcat((yyval.st).code, "\n");
		...
		strcat((yyval.st).code, "\nJMP ");
		int jmp1_loc = memory+(yyvsp[-2].st).size+3;		
		...
		strcat((yyval.st).code, "\nJMP ");
		int jmp2_loc = jmp1_loc + (yyvsp[0].st).size;		
		...
		strcat((yyval.st).code, "\n");		
		strcat((yyval.st).code, l3); strcat((yyval.st).code, ": ");		
		(yyval.st).size = jmp2_loc - memory;
		memory = jmp2_loc;
		free((yyvsp[-4].expr_st).code); 
		free((yyvsp[-2].st).code);
		free((yyvsp[0].st).code);
	}
...
#line 311 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st).type = (yyvsp[0].val).type; 
				...
				(yyval.expr_st).code = (char*)malloc((strlen(ss) + 18)*sizeof(char));
				int reg = getreg((yyval.expr_st).place);
				sprintf((yyval.expr_st).code, "\nMVI R%d, ", reg);
				strcat((yyval.expr_st).code, ss);
				add_address((yyval.expr_st).place, reg, 0);
				memory += 2;
				(yyval.expr_st).size = 1;
			}
#line 1700 "y.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 328 "target.y" /* yacc.c:1646  */
    { 	
...
#line 1714 "y.tab.c" /* yacc.c:1646  */
  ...
  case 29:
#line 339 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "+", (yyvsp[0].expr_st)); }
#line 1720 "y.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 340 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "-", (yyvsp[0].expr_st)); }
#line 1726 "y.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 341 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "*", (yyvsp[0].expr_st)); }
#line 1732 "y.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 342 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "/", (yyvsp[0].expr_st)); }
#line 1738 "y.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 343 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "%", (yyvsp[0].expr_st)); }
#line 1744 "y.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 345 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), ">", (yyvsp[0].expr_st)); }
#line 1750 "y.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 346 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "<", (yyvsp[0].expr_st)); }
#line 1756 "y.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 347 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "|", (yyvsp[0].expr_st)); }
#line 1762 "y.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 348 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "&", (yyvsp[0].expr_st)); }
#line 1768 "y.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 349 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), ">=", (yyvsp[0].expr_st)); }
#line 1774 "y.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 350 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "<=", (yyvsp[0].expr_st)); }
#line 1780 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 352 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "<<", (yyvsp[0].expr_st)); }
#line 1786 "y.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 353 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), ">>", (yyvsp[0].expr_st)); }
#line 1792 "y.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 354 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "&&", (yyvsp[0].expr_st)); }
#line 1798 "y.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 355 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "||", (yyvsp[0].expr_st)); }
#line 1804 "y.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 356 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "==", (yyvsp[0].expr_st)); }
#line 1810 "y.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 357 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = codegen((yyvsp[-2].expr_st), "!=", (yyvsp[0].expr_st)); }
#line 1816 "y.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 359 "target.y" /* yacc.c:1646  */
    {	(yyval.expr_st) = codegenAssign((yyvsp[-2].tokname), (yyvsp[0].expr_st)); }
#line 1822 "y.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 361 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "+=", (yyvsp[0].expr_st)); }
#line 1828 "y.tab.c" /* yacc.c:1646  */
    break;

  case 48:
#line 362 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "-=", (yyvsp[0].expr_st)); }
#line 1834 "y.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 363 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "%=", (yyvsp[0].expr_st)); }
#line 1840 "y.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 364 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "*=", (yyvsp[0].expr_st)); }
#line 1846 "y.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 365 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "/=", (yyvsp[0].expr_st)); }
#line 1852 "y.tab.c" /* yacc.c:1646  */
    break;

  case 52:
#line 366 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "&=", (yyvsp[0].expr_st)); }
#line 1858 "y.tab.c" /* yacc.c:1646  */
    break;

  case 53:
#line 367 "target.y" /* yacc.c:1646  */
    { 	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "|=", (yyvsp[0].expr_st)); }
#line 1864 "y.tab.c" /* yacc.c:1646  */
    break;

  case 54:
#line 368 "target.y" /* yacc.c:1646  */
    {	(yyval.expr_st) = codegenAssignCompound((yyvsp[-2].tokname), "^=", (yyvsp[0].expr_st)); }
#line 1870 "y.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 370 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = (yyvsp[-1].expr_st); }
#line 1876 "y.tab.c" /* yacc.c:1646  */
    break;

  case 56:
#line 374 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = shorthand((yyvsp[-1].tokname), "++"); }
#line 1882 "y.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 375 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = shorthand((yyvsp[-1].tokname), "--"); }
#line 1888 "y.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 376 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = shorthand((yyvsp[0].tokname), "++"); }
#line 1894 "y.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 377 "target.y" /* yacc.c:1646  */
    { (yyval.expr_st) = shorthand((yyvsp[0].tokname), "--"); }
#line 1900 "y.tab.c" /* yacc.c:1646  */
    break;

  case 60:
#line 378 "target.y" /* yacc.c:1646  */
    {
